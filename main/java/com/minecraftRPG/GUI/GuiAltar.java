...
public class GuiAltar extends GuiContainer{
	...
	public GuiAltar(InventoryPlayer invPlayer, AlterPedestalTileEntity tile) {
		super(new CointainerAltarPedestal(invPlayer, tile));
		this.tileAltar = tile;
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		 GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
	        ...
	        {
	            i1 = this.tileAltar.getBurnTimeRemainingScaled(12);
	            this.drawTexturedModalRect(k + 56, l + 36 + 12 - i1, 176, 12 - i1, 14, i1 + 2);
	        }

	        i1 = this.tileAltar.getCookProgressScaled(24);
